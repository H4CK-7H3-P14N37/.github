...
## 🔐 Passwords & Wordlists
- [3.7-billion-passwords-tools](https://github.com/philipperemy/3.7-billion-passwords-tools)
- [Dan Miessler’s SecLists](https://github.com/danielmiessler/SecLists)
- [clem9669 Wordlists](https://github.com/clem9669/wordlists)
- [duplicut](https://github.com/nil0x42/duplicut)
- [initstring lyricpass](https://github.com/initstring/lyricpass)
- [initstring passphrase-wordlist](https://github.com/initstring/passphrase-wordlist)
- [zxcvbn - Password Strength Estimator](https://github.com/dropbox/zxcvbn)
- [korelogic-rules](https://github.com/SpiderLabs/KoreLogic-Rules)
...
- [caeksec/rules](https://github.com/caeksec/rules)
...
- [Michael Grafnetter’s DSInternals](https://github.com/MichaelGrafnetter/DSInternals)
...
- [rmml](https://github.com/LivingInSyn/RMML)
- [Eyewitness](https://www.kali.org/tools/eyewitness/)
- [GoBuster](https://github.com/OJ/gobuster)
- [DowJones Hammer](https://github.com/dowjones/hammer)
...
- [prowler - AWS Security Scanner](https://github.com/prowler-cloud/prowler)

---

## 🎯 Command & Control (C2) Frameworks
- [C3 - Custom C2 Communication](https://github.com/WithSecureLabs/C3)
...
- [insightvm-sql-queries](https://github.com/rapid7/insightvm-sql-queries)
...
- [Arkime - Full Packet Capture](https://github.com/arkime/arkime)
- [Raspberry Pi Scripts](https://github.com/wtsxDev/Raspberry-Pi)
...
## 🛡️ Web Security, Honeypots, & WAF
- [Astra WAF](https://github.com/flipkart-incubator/Astra)
...
- [go-app-ticker-wall](https://github.com/polygon-io/go-app-ticker-wall)
- [homer](https://github.com/bastienwirtz/homer)
- [uhp - Ultimate Hacker Panel](https://github.com/MattCarothers/uhp)
...
- [Ghostty - Modern Themed Terminal Emulator](https://ghostty.org)
...
- [busybotnet](https://github.com/isdrupter/busybotnet)
- [charlotte](https://github.com/9emin1/charlotte)
- [chrome-extensions-examples](https://github.com/orbitbot/chrome-extensions-examples)
...
- [pen-testing](https://github.com/s1l3ntk1ll3r/Pen-Testing)
- [pentesting_scripts](https://github.com/vonahisec/pentesting_scripts)
- [redis-cluster-with-sentinel](https://github.com/mustafaileri/redis-cluster-with-sentinel)
- [streamingphish](https://github.com/wesleyraptor/streamingphish)
- [asn-ip](https://github.com/ipverse/asn-ip)
- [email-header-analyzer](https://github.com/cyberdefenders/email-header-analyzer)
- [generate-ipdatabase](https://github.com/sohonetlabs/generate-ipdatabase)
